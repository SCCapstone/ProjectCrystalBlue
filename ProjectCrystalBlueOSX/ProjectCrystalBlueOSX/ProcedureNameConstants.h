...
static NSString *const PROC_NAME_GEMENI_DOWN                = @"Gemeni DOWN";
static NSString *const PROC_NAME_GEMENI_UP                  = @"Gemeni UP";
...
static NSString *const PROC_TAG_GEMENI_DOWN             = @"GMv";
static NSString *const PROC_TAG_GEMENI_UP               = @"GM^";
